fn main() {
    ...
    // 1. SELECT MENU (Handles cleaning up automatically)
    ...
    // 2. INPUTS (Replaces the prompt line with the answer after typing)
...
// ... keep your commit function exactly as it was ...
